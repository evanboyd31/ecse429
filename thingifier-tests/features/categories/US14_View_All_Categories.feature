...
So that I can evaluate the organization of my todos and projects.
  ...
  Scenario: User views all categories using JSON (Normal Flow)
  ...
  Scenario: User views all categories using XML (Alternate Flow)
  ...
  Scenario: User attempts to view all categories when no categories exist (Error Flow)
