...
So that I can see its associated todos and projects.
  ...
  Scenario: User views a specific category by id (Normal Flow)
  ...
  Scenario: User views a specific category by title (Alternate Flow)
  ...
  Scenario: User attempts to view a category that does not exist (Error Flow)
