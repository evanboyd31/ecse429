...
So that I can tag my todos and/or projects.
  ...
  Scenario Outline: Student creates a category with all fields (Normal Flow)
    When the student attempts to create a category with title "<title>" and description "<description>"
  ...
  Scenario Outline: Student creates a category with missing fields (Alternate Flow)
  ...
  Scenario Outline: Student attempts to create a category with a pre-specified ID (Error Flow)
    When the student attempts to create a category with id "<id>", title "<title>" and description "<description>"
