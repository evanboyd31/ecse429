...
def test_post_id_categories_allfields_should_return_categorymodified(setup_module, setup_each):
...
def test_post_id_categories_titlefield_should_return_categorymodified(setup_module, setup_each):
...
def test_post_id_categories_conflictid_should_return_badrequest(setup_module, setup_each):
...
def test_post_id_categories_nonexistent_should_return_notfound(setup_module, setup_each):
...
def test_post_id_categories_query_conflicting_should_return_badrequest(setup_module, setup_each):
...
def test_post_id_categories_modifyid_should_return_categorymodified(setup_module, setup_each):
    print("Running test_post_id_categories_query_conflicting_should_return_badrequest")
