...
def test_get_categories_id_should_return_corresponding_category(setup_module, setup_each):
...
def test_get_categories_id_nonexsistent_should_return_error(setup_module, setup_each):
...
def test_get_categories_id_query_inconsistent_should_return_badrequest(setup_module, setup_each):
