...
def test_put_project_filter_by_title_should_not_update_projects_with_title_json(
    before_each,
):
...
def test_put_project_filter_by_title_should_not_update_projects_with_title_xml(
    before_each,
):
    test_project = test_projects[0]
